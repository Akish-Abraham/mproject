...
/* Admin Pages */
import AdminAddClient from './admin/AdminAddClient.js';
import AdminClientList from './admin/AdminClientList.js';

import AdminAddManagers from './admin/AdminAddManagers.js';
import AdminEditManagers from './admin/AdminEditManagers.js';
import AdminManagersList from './admin/AdminManagersList.js';
                                ...
                                <div id="content">
                                    ...
                                    <div className="container-fluid">
                                        <Routes>
                                            ...
                                            <Route path="/admin-add-client" element={<AdminAddClient location={this.location.bind(this)} navigate={this.navigate.bind(this)} menuactive={this.handleMenuChange.bind(this)} />} />
                                            ...
                                            <Route path="/admin-add-managers" element={<AdminAddManagers location={this.location.bind(this)} navigate={this.navigate.bind(this)} menuactive={this.handleMenuChange.bind(this)} />} />
                                            <Route path="/admin-edit-managers" element={<AdminEditManagers location={this.location.bind(this)} navigate={this.navigate.bind(this)} menuactive={this.handleMenuChange.bind(this)} />} />
                                            <Route path="/admin-list-managers" element={<AdminManagersList location={this.location.bind(this)} navigate={this.navigate.bind(this)} menuactive={this.handleMenuChange.bind(this)} />} />
